...
l2_out_train_label = '../../Result/l2_out_train_label.txt'
l2_raw_train_label = '../../Data/l1_crop/l1_crop_train_label.txt'
relative_path = '../../Data/l1_crop/train/' 	# find the image from txt
draw_img_flod = '../../Result/l2_out_draw/train/'
drop_img_flod = '../../Result/l2_drop/train/'

n_p = 5
# ----------------------------------------------------------------------- load label
l2_raw_fid = open(l2_raw_train_label)		
l2_raw_lines = l2_raw_fid.readlines()
l2_raw_fid.close()
l2_out_fid = open(l2_out_train_label)
