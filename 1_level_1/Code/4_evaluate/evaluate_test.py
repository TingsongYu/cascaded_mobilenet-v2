...
l1_out_test_label = '../../Result/l1_out_test_label.txt'
l1_raw_test_label = '../../Data/l1_test_label.txt'
relative_path = '../../../raw_data/Data/img_celeba/' 	# find the image from txt
draw_img_flod = '../../Result/l1_out_draw/test/'
drop_img_flod = '../../Result/l1_drop/test/'
